...
public class RackArrayImplTest {
    ...
    public void constructorDefault() throws Exception {
        RackArrayImpl rack0 = new RackArrayImpl(5);
    ...
    public void constructorDefault_SizeNegative() throws Exception {
        RackArrayImpl rack0 = new RackArrayImpl(-5);
    }

    @Test
    public void constructorDefault_Size0() throws Exception {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void constructor_SizeNegative() throws Exception {
        RackArrayImpl rack0 = new RackArrayImpl(-5, Battery.class);
    }

    @Test
    public void constructor_Size0() throws Exception {
    ...
    @Test
    public void getSize_0() throws Exception {
        int expResult0 = 0;
    ...
    @Test
    public void getSize_3() throws Exception {
        int expResult3 = 3;
    ...
    @Test(expected = IllegalArgumentException.class)
    public void insertDevToSlot_BadDeviceType() throws Exception {
        Switch badBattery = new Switch();
        badBattery.setIn(5);
